    ...
    <form id="form1" runat="server">
        ...
        <div class="container mt-5">
            ...
            <div class="box">
                <div class="name m-2 p-2">
                    <div class="my-2">
                        <div class="text-start fw-bold px-1 my-2">Image Content:</div>
                    </div>
                    <div class="d-flex">
                        <div>
                ...
                <div class="images m-2 p-2">
                    <div class="my-2">
                        <div class="text-start fw-bold px-1 my-2">Images:</div>
                    </div>
                    <div class="d-flex">
                        <div>
                ...
                <div class="file m-2 p-2">
                    <div class="my-2">
                        <div class="text-start fw-bold px-1 my-2">File:</div>
                    </div>
                    <div class="d-flex">
                        <div>
                            <asp:FileUpload ID="fileuploadfile" CssClass="form-control" runat="server" />
                        </div>
                    </div>
        ...
        <div class="container mt-5">
           <div class="tbl-overflow">
                <asp:GridView ID="Gridview1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-responsive overflow-auto tbl-bg"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name">
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Bind("ImageContent") %>' ID="txttblname"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Bind("ImageContent") %>' ID="lbltxtname"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Images">
                            <EditItemTemplate>
                                <asp:Image runat="server" Text='<%# Eval("Images") %>' ID="tblimage"></asp:Image><br />
                                <asp:FileUpload ID="fileuploadtblimg" runat="server" />
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Image runat="server" ImageUrl='<%# Eval("Images") %>' Height="112px" Width="100px" ID="tblimg"></asp:Image><br />
                        ...
                        <asp:TemplateField HeaderText="Files">
                            <EditItemTemplate>
                                <asp:Image runat="server" Text='<%# Eval("Files") %>' ID="tblfile"></asp:Image><br />
                                 <asp:FileUpload ID="fileuploadtblfile" runat="server"/>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Image runat="server" ImageUrl='<%# Eval("Files") %>' Height="112px" Width="100px" ID="tblfile"></asp:Image><br />
